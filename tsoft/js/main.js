	...
	function loadMarkers(personList) {
		...
		for( i=0; i < people.length; i++ ) {
			...
			var marker = new google.maps.Marker({
				...
				branchname+='<div class="contact_list">'+
					'<ul class="contact_list_item rel">'+
					'<li>'+
						'<img class="contact_list_th" src="https://dl.dropboxusercontent.com/u/23834858/fotos/ALF.jpg">'+
					'</li>'+
					'<li><b>Name: </b>'+'<b><a class="marker-link" data-markerid="'+i+'" href="#" >'+person.name+'</a></b>'+'</li>'+
						'<li><b>Age: </b>'+person.age+'</li>'+
						'<li><b>from: </b>'+person.from+'</li>'+
						'<li><b>Followers: </b>'+person.followers+'</li>'+
						'<li><b>College: </b>'+person.college+'</li>'+
					'</ul>'+
					'</div>';

//branchname+='<p><a class="marker-link button" data-markerid="'+i+'" href="#" >'+(i+1)+')'+person.name+'</a></p>';///////
		...
		document.getElementById('markers').innerHTML+= branchname;										///////
